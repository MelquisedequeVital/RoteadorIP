            ...
            switch (opcao) {
                case 1:
                    ...
                    try {
                        ...
                        if (nomeInterface.isEmpty()) {
                            ...
                            throw new IllegalArgumentException("O nome da interface não pode ser vazio.");
                        }
                ...
                case 2:
                    ...
                    try {
                        ...
                        // Se todas as conversões acima forem bem-sucedidas, o código continua aqui:
                        ...
                        System.out.println("\nErro ao cadastrar rota: " + e.getMessage());
                    }
                    break;
                ...
                case 4:
                    ...
                    try {
                        ...
                        System.out.println("\nErro ao tentar alterar rota: " + e.getMessage());
                    }
                ...
                case 5:
                    ...
                    // --- Bloco Try-Catch para validar as entradas de IP/Máscara ---
                    try {
                        System.out.println("\n--- Remover Rota ---");
                        ...
                        // Se as conversões forem bem-sucedidas, a lógica de remoção é executada:
                        ...
                        System.out.println("\nErro ao tentar excluir rota: " + e.getMessage());
                    }
                    break;
                ...
                case 7:
                    ...
                    try {
                        ...
                        if (rotaCalculada != null) {
                            // Reconstroi as strings de IP/Gateway para exibição
